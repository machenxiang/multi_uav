 ...
 * figure8_circle
 *
 * Author: Copy from https://gitee.com/bingobinlw/volans
 *
...
int main(int argc, char **argv)
{
    ...
    //ros::ServiceClient land_client = nh.serviceClient<mavros_msgs::CommandTOL>("/iris_0/mavros/cmd/land");
    //ros::ServiceClient set_mode_client = nh.serviceClient<mavros_msgs::SetMode>("/iris_0/mavros/set_mode");
    ros::Publisher target_local_pub = nh.advertise<mavros_msgs::PositionTarget>("/iris_0/mavros/setpoint_raw/local",100);
